          ...
          <div className="hidden md:flex justify-center items-center gap-1 h-11">
            {navigationItems.map((item) => (
              <button
                ...
                className={`px-4 py-2 rounded-md text-sm font-medium transition-all duration-300 hover:scale-105 whitespace-nowrap ${activeSection === item.id
            ...
            <div className="flex flex-col space-y-1">
              {navigationItems.map((item) => (
                <button
                  ...
                  className={`px-4 py-2.5 text-left rounded-lg text-sm font-medium transition-all duration-300 ${activeSection === item.id
            ...
            <div className="flex justify-center gap-2 mb-6">
              {[0, 1, 2].map((i) => (
                <button
                  ...
                  className={`h-2 rounded-full transition-all duration-300 ${avaliacaoSlide === i
            ...
            <div className="flex justify-center gap-4 mb-8 flex-wrap">
              {[
                ...
                <button
                  ...
                  className={`flex items-center gap-2 px-4 py-2 rounded-full text-sm font-medium transition-all duration-300 ${avaliacaoSlide === idx
                ...
                <div className="bg-white dark:bg-gray-800 rounded-3xl border border-purple-100 dark:border-purple-900/50 shadow-xl p-8">
                  <div className="flex items-center gap-3 mb-7">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500 dark:text-gray-400">35 respondentes válidos · 9 avaliações por e-mail · Residentes HdB - Jan/2026</p>
                    </div>
                  </div>

                  <div className="space-y-5 text-gray-700 dark:text-gray-300 leading-relaxed">
                    <p>
                      Ao longo do período de testes, os residentes do programa Hackers do Bem utilizaram as ferramentas
                      AutoClass-LFI e Anon-LFI como parte das atividades práticas de formação. Ao final, 35 residentes
                      responderam a um formulário estruturado avaliando usabilidade, qualidade do conteúdo e experiência
                      geral de uso. Adicionalmente, avaliações detalhadas foram enviadas por e-mail, com observações
                      técnicas e pedagógicas específicas sobre cada ferramenta.
                    </p>
                    <p>
                      A receptividade foi, de modo geral, bastante positiva. A maioria dos residentes destacou que as
                      ferramentas proporcionaram uma experiência próxima à de um ambiente profissional real - cenário
                      que não se vê muito em treinamentos mais tradicionais da área. O contato com incidentes reais
                      anonimizados foi apontado repetidamente como o principal diferencial da proposta.
                    </p>
                    <p>
                      Entre os pontos de atenção, instabilidades no processamento de uploads e inconsistências de
                      interface foram os achados mais recorrentes, consolidados em 31 issues priorizadas no backlog
                      técnico do projeto. Nenhum dos problemas levantados comprometeu o uso das ferramentas, mas
                      indicam caminhos claros de melhoria para as próximas versões.
                    </p>
                    <p>
                      No geral, os resultados reforçam que a proposta central - oferecer um ambiente de treinamento
                      baseado em incidentes reais - está sendo bem recebida pelos alunos e tem potencial pedagógico.
                    </p>
                  </div>
                </div>
              </div>
